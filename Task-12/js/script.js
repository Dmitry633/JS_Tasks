...
// Задание 11. Создадим модальное окно
   ...
   // let more = document.querySelector('.more'),
    ...
    function modWin (arg) {
        let a = document.querySelectorAll(arg);
...
/*
    ...
    close.addEventListener('click', function(){
        overlay.style.display = 'none';
        more.classList.remove('more-splash');//this нам уже то=ут не подходит, т к мы поппадем на сам крестик, потму меняем на more
        document.body.style.overflow = '';
    })
